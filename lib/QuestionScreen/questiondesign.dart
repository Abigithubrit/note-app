...
import 'package:allnotes/QuestionScreen/Questiondetalscreen.dart';
...
class QuestionsDesignWidget extends StatefulWidget {
  Items? model;
  BuildContext? context;

  QuestionsDesignWidget({this.model, this.context});

  @override
  _QuestionsDesignWidgetState createState() => _QuestionsDesignWidgetState();
}

class _QuestionsDesignWidgetState extends State<QuestionsDesignWidget> {
