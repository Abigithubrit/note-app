...
class LongUploadScreen extends StatefulWidget {
 final Items? model;

  const LongUploadScreen({super.key, this.model});

  @override
  State<LongUploadScreen> createState() => _LongUploadScreenState();
}

class _LongUploadScreenState extends State<LongUploadScreen> {
