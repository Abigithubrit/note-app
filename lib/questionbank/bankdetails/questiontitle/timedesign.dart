...
class TimeWidget extends StatefulWidget {
  ...
  TimeWidget({this.model, this.context});
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              Text('Full marks: '+widget.model!.full.toString()+' marks',
                style: TextStyle(
                  fontSize: 15,
                ),),
                
                Text('Pass marKs: '+widget.model!.pass.toString()+' marks',
                style: TextStyle(
                  fontSize: 15,
                ),),
                Text('Time: '+widget.model!.time.toString()+" hours",
                style: TextStyle(
                  fontSize: 15,
                ),),
