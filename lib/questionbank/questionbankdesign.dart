...
class QuestionBankDesignWidget extends StatefulWidget {
  Items? model;
  BuildContext? context;

  QuestionBankDesignWidget({this.model, this.context});

  @override
  _QuestionBankDesignWidgetState createState() => _QuestionBankDesignWidgetState();
}

class _QuestionBankDesignWidgetState extends State<QuestionBankDesignWidget> {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (c) => BankScreen(model: widget.model)));
      },
              ...
              children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Question Paper: '+widget.model!.year.toString(),
                        style: TextStyle(
                          fontSize: 20
                        ),),
                        Row(
                          children: [
                            Text('year: '+widget.model!.year.toString()),
                            
                          ],
                        ),
                        SizedBox(height: 2,),
                        Text(
                            'course:'+  widget.model!.course.toString(),
                        style: const TextStyle(
                          ...
                          fontFamily: "Signatra",
                                      ...
                                      Text('Semester: '+widget.model!.sem.toString()+' Semester')
                      ],
                    ),
                  ),
                                 Padding(
